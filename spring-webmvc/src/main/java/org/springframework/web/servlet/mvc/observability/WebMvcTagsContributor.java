...
public interface WebMvcTagsContributor {
	 ...
	 */
	Iterable<Tag> getTags(HttpServerRequest request, HttpServerResponse response, Object handler,
			Throwable exception);
	 ...
	 */
	Iterable<Tag> getLongRequestTags(HttpServerRequest request, Object handler);
