...
/**
 * A {@link RecordingSubscription} is a {@link Subscription} that fakes being {@link Fuseable}
 ...
 */
interface RecordingSubscription<T> extends Subscription, CoreSubscriber<T>, Fuseable.QueueSubscription<T> {
