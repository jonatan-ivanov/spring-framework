...
package org.springframework.core.observability.test;
...
public class TestRecordingListener implements RecordingListener<TestContext> {
	...
	private IntervalRecording<TestContext> onCreateRecording;
	...
	private IntervalRecording<TestContext> onRestoreRecording;
	...
	public IntervalRecording<TestContext> getOnRestoreRecording() {
		return this.onRestoreRecording;
	}

	public Snapshot getOnRestoreSnapshot() {
		return this.onRestoreSnapshot;
	}

	public IntervalRecording<TestContext> getOnCreateRecording() {
		return this.onCreateRecording;
	}

	public Snapshot getOnCreateSnapshot() {
		return this.onCreateSnapshot;
	}
